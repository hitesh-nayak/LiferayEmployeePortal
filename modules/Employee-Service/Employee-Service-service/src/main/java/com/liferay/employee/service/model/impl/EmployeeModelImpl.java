...
public class EmployeeModelImpl
	...
	static {
		...
		attributeGetterFunctions.put("empLastName", Employee::getEmpLastName);
		attributeSetterBiConsumers.put(
			"empLastName",
		...
		attributeGetterFunctions.put("companyName", Employee::getCompanyName);
		attributeSetterBiConsumers.put(
			"companyName",
			(BiConsumer<Employee, String>)Employee::setCompanyName);
		attributeGetterFunctions.put("profImageId", Employee::getProfImageId);
		attributeSetterBiConsumers.put(
			"profImageId",
